...
pub use cube::{
    ...
    ClosedAxisLabel, ModalityClass, ParseAxisHistogramError, PartialInverseCube, PartitionFace,
    PartitionOrdinal, ProductCube, at_partition_ordinal, axis_at, axis_cardinality,
