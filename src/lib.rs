...
pub use cube::{
    AxisHistogram, AxisHistogramIntoIter, AxisHistogramIter, ClosedAxis, ClosedAxisLabel,
    PartialInverseCube, PartitionFace, PartitionOrdinal, ProductCube, at_partition_ordinal,
