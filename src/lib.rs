...
pub use cube::{
    ...
    ClosedAxisLabel, ParseAxisHistogramError, PartialInverseCube, PartitionFace, PartitionOrdinal,
    ProductCube, at_partition_ordinal, axis_at, axis_cardinality, axis_from_label, axis_histogram,
    axis_iter, axis_label, axis_ordinal, forward_iter, partition_ordinal, realizable_at,
