...
pub use discovered::{
    ...
    has_contributor, has_silent_layer, is_contested_at, is_touched_at, layer_names,
    nonempty_layer_dicts, silenced_at, silenced_count_at, silent_layer_count, silent_layer_names,
};
pub use discovery::{
