    ...
    crates = {
      ...
      "gen-macros" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "82cd91cb08026be0a758cfde3cd7ba96301b3c1c";
          sha256 = "1v6g8mqvxawyadca91dil1xa6lpxx0d3pbxkv7b5v8knyfmv9m5m";
        };
        procMacro = true;
        libName = "gen_macros";
        authors = [
      ...
      "tatara-lisp" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "6ea3b9b13155368d9ad3dc93a2a82f45e2a0be09";
          sha256 = "1f39fvf7396rnm4gdkm2hf6ylhvr3md8m804dikxmsc9zbaqr6sf";
        };
        libName = "tatara_lisp";
        authors = [
